                            ...
                            <div className="mt-14 flex justify-end gap-8 sm:-mt-44 sm:justify-start sm:pl-20 lg:mt-0 lg:pl-0">
                                <div className="ml-auto w-44 flex-none space-y-8 pt-32 sm:ml-0 sm:pt-80 lg:order-last lg:pt-36 xl:order-none xl:pt-80">
                                    <div className="relative">
                                        <img
                                            src="https://www.thegardenwebsite.com/uploads/8/4/5/5/84557242/prunus-lusitanica-point-grey-foreshore-june-22_orig.jpg"
                                            alt=""
                                ...
                                <div className="mr-auto w-44 flex-none space-y-8 sm:mr-0 sm:pt-52 lg:pt-36">
                                    <div className="relative">
                                        <img
                                            src="https://www.camdennurseries.com.au/wp-content/uploads/2022/03/Yucca-aloifolia-400mm-scaled.jpg"
                                            alt=""
                                            className="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
                                        />
                                        <div className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10" />
                                    ...
                                    <div className="relative">
                                        <img
                                            src="https://www.camdennurseries.com.au/wp-content/uploads/2022/03/Buxus-microphylla-_Japanese-Box_-ball-300mm-scaled.jpg"
                                            alt=""
                                            className="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
                                        />
                                        <div className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10" />
                                ...
                                <div className="w-44 flex-none space-y-8 pt-32 sm:pt-0">
                                    <div className="relative">
                                        <img
                                            src="https://i0.wp.com/plantingman.com/wp-content/uploads/2021/04/Spanish-moss.jpg?w=1200&ssl=1"
                                            alt=""
                                            className="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
                                        />
                                        <div className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10" />
                                    ...
                                    <div className="relative">
                                        <img
                                            src="https://cdn3.volusion.com/uyqbk.sezkn/v/vspfiles/photos/SHRBOR-BURNING-BUSH-2.jpg?v-cache=1655994472"
                                            alt=""
                                            className="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
                                        />
                                        <div className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10" />
